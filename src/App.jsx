...
function RoadmapDrawer({ epic, weeks, onClose, onSave, onDelete, canEdit }) {
  const { T, PRODUCT_STYLE } = useTheme();
...
function RoadmapScreen() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", flex: 1, minWidth: 0 }}>
      ...
      <RoadmapDrawer epic={openEpic} weeks={weeks} onClose={() => setOpenKey(null)} onSave={saveDrawer} onDelete={deleteEpic} canEdit={ownsCard(openEpic)} />
    </div>
  );
}
